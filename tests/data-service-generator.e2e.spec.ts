...
describe("Data Service Generator", () => {
  ...
  describe.each(testCases)(
    "for a service with $name test case",
    ({ name, data }) => {
      ...
      beforeAll(async () => {
        ...
        // TODO replace with a better docker-compose solution that waits for the migration to be completed before starting the server
